...
//     script.src = 'https://itunes.apple.com/search?term=${termo}&media=music$limit=15&callback=processarRepositar';
...
function exibirResultados(musicas){
    ...
    musicas.forEach(musica => {
        ...
        const capaUrl = musica.artworkUrl100.replace('100x10', '400x400');
